...
export default function DetalleServicioCliente() {
  ...
  if (!service || errorType === "not_found") {
    return (
      <div className="card min-h-[50vh] p-8 text-center flex flex-col items-center justify-center">
        ...
        <Link to="/cliente/servicios" className="font-medium text-violet-600 underline hover:text-violet-700">
          Volver al catalogo
        </Link>
      </div>
    );
  ...
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
      <Link to="/cliente/servicios" className="inline-flex items-center gap-2 mb-8 text-sm font-medium text-violet-600 transition-colors hover:text-violet-700">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-[minmax(0,1.1fr)_minmax(0,0.9fr)] gap-10 lg:gap-16">
        ...
        <div className="flex flex-col justify-center">
          ...
          <p className="mt-4 text-lg leading-8 text-slate-600">
            {service.descripcion || "Consulta el detalle completo del servicio antes de agendar o pagar."}
          </p>
