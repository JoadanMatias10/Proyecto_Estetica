...
export function getCompanyInfo() {
  ...
  return {
    ...
    horarioLunesSabado: normalizeString(raw.horarioLunesSabado, DEFAULT_COMPANY_INFO.horarioLunesSabado),
    horarioDomingo: normalizeString(raw.horarioDomingo, DEFAULT_COMPANY_INFO.horarioDomingo),
