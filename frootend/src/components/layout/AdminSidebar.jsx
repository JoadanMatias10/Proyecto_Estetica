...
export default function AdminSidebar() {
  const links = [
    ...
    { to: "/admin/servicios/categorias", label: "Categorias Servicios", icon: "services" },
    { to: "/admin/promociones", label: "Promociones", icon: "promotions" },
    { to: "/admin/productos", label: "Catalogo de Productos", icon: "products" },
    { to: "/admin/productos/categorias", label: "Categorias Productos", icon: "products" },
    { to: "/admin/productos/marcas", label: "Marcas Productos", icon: "products" },
